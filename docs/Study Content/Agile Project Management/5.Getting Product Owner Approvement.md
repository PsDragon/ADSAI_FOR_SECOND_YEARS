...
- [ ] **The Assessment** <br>
  ...
  <br>
So, after creating a task/story in trello, estimated it and planned it in, you will:
1. Add (an) ILO label(s)
2. Add an evidence link after complete the task/subtask
3. Mark the task/subtask as done by marking it as illustrated or moving it on the board.
