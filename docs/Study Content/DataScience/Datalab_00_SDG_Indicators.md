...
## 0) Watch the SDG Introduction
An easy introduction onto the topic. If you cringe too much on TED talks, feel free skip to the next video.
...
## 1) SDG introduction to data scientists
...
## 2) A more technical introduction
...
## 3) Whenever you need more information
