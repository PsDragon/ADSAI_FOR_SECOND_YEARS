...
This data-lab day will focus on gaining some skills to make very pretty plots with the famous ggplot2 package. Then we're going to use our new skills to create some, hopefully, cool graphs and visualisations for our data-lab project.
