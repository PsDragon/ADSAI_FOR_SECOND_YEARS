...
sort: 16
---
# Explanatory versus Predictive Modelling + Writing a Conclusion
Today we will review different types of analyses; and all the different terms people like to give them (that's a downside of an emerging field; R.I.P. us). We're also going to look at what constitutes a good or bad prediction. So, today we'll explore some theoretical concepts to allow you to form a clearer picture of what constitutes data science. To prepare for Datalab, we're going to learn to write our conclusion and how to reference our sources today. 
...
1. Big Data
2. Good and bad predictions: 0.5 hours
3. Workshop on reporting: 3 hours (Optional)
4. Conclusion: 1 hour
5. Referencing: 1 hour
6. Iterating on Dashboard: - 
...
## 3) Workhop: Reporting (Optional)
Time for another [workshop on data reporting in Power BI](https://app.datacamp.com/learn/courses/report-design-in-power-bi) to expand our data reporting skills in Power BI so we can better write the and report your results. We already looked at this from several angles but convey our data understanding is essential so we're going to take another look at it. Complete the entire course and upload the certificate to github, reference the certificate in your learning log for this week.



## 4) Write the Conclusion - Preparation for next DataLab!
...
## 5) Referencing - Preparation for next DataLab!
When we're doing any kind of research we're always making assumptions and these are based on sources who did research before we even started. So when we're doing research we're always standing on the shoulders of all the researchers who came before us. That's why referencing is important we need to know how you justify making the assumptions you make. These references; or assumptions, allow you to do an analysis in the first place because they put your work into context and demponstrate the breadth and depth of your research! They also help to combat plagiarism. Therefore, we're going to cite any sources used for our data science project in the conference dashboard.

One of the most popular ways to reference is the American Psychological Association style (APA-style) method. You are encouraged to use and delve into that! Open you self-assessment rubric in Teams, look through it and determine whether or not you need to reference in APA for this assignment. Do you need to? This is something to discuss with your peers in the next datalab! There are some good APA referencing tools available. [Google Scholar]() is a good one. The [Scribbr Citation Tool](https://www.scribbr.com/apa-citation-generator/) also seems to be good. There are other tools available as well.
...
Remember that **the deadline for handing in the Dashboard is Friday (21-10) of week 7 at 17:00!**


## 6) Iterate on your Dashboard
Open your dashboard, iterated, save changes and commit the new version to Github.
