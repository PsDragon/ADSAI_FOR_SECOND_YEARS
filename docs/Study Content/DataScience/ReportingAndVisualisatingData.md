...
## Learning Objectives
Enable you to:
1. Compellingly report data and findings;
2. Make advanced visualisations with GGplot2 in R.
...
## 0) How do we report data?
Well, essentially, you want to present your data, model, and information in such a way that it convinces the target audience. So let’s start by do the course below. It explains in detail how to present your data; by telling a story:
...
## 1) How do we visualize data?
Complete the [Learn GGplot2](https://www.codecademy.com/learn/learn-ggplot-2) course on Codecademy. If you feel like you master the GGplot2 syntax I recommend skipping chapter 1 "Learn R: Fundamental of Data Visualisation with GGplot2".
