...
2. Make sure that before delivering the notebooks, **Restart & Run all** so that:
  - Cells are ran in order.
  - Cell outputs are visible.

Take a look at this [exercise](https://github.com/BredaUniversityADSAI/2022-23-Y1-BlockC/blob/main/Self-Study/W3/Gradient_descent_exercises.ipynb)-[solution](https://github.com/BredaUniversityADSAI/2022-23-Y1-BlockC/blob/main/Self-Study/W3/Gradient_descent_solutions.ipynb) pair. Your deliverables should like the solution notebook, cells are in order, outputs are visible.
