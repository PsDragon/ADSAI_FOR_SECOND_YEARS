...
It's time to put what you have learned into practice! In this DataLab you will develop Multilayer Perceptrons using Keras for different datasets. The DataLab is structured as a notebook file. You will see this format frequently in this Deep Learning module. First read the material in this page. Then, to start the DataLab, open the file `W2-DL1-MLP-Student-Notebook.ipynb`, download the notebook to Block C github repos, and continue there on the tasks.
