...
And once you are done developing your model, you can test it on the test set.
...
Notice that Option 1 is easier to implement. But typically, you would like to have access to your validation data. After training the model, you need to evaluate your model performance which includes calculating metrics on the validation set. Therefore Option 2 is better in most cases.
