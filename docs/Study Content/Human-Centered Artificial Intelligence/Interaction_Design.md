...
Note that you need to log into the BUas SSO (Single Sign-On) to view the video; e.g. log into your student portal. If you are signed in and it still doesn't work, contact Bram Heijligers using the Q&A channel. If that still doesn't work, [please click here](https://edubuas-my.sharepoint.com/:v:/g/personal/heijligers_b_buas_nl/ESndamhQN_FOmdT94N6-77gBcaP7D4ijhLsmXY6YXucbGg?e=gpQuU3)
