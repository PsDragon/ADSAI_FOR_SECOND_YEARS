...
Missed the kick-off? Watch it back [over here!](https://edubuas-my.sharepoint.com/:v:/g/personal/heijligers_b_buas_nl/EePBk45bPTNEgJmmRGIT-moBZFB-UbKlZcEJkEpPIix-Vg?e=J2T8Sw)
...
<div style="padding: 15px; border: 1px solid transparent; border-color: transparent; margin-bottom: 20px; border-radius: 4px; color: #8a6d3b;; background-color: #fcf8e3; border-color: #faebcc;">
Tip: Rusty on writing problem statements? Watch the [linkedin learning video from DS1 again](https://www.linkedin.com/learning/academic-research-foundations-quantitative/how-to-develop-a-problem-statement?trk=embed_lil)!
 </div>
