...
We're going to follow the systematic method since we're working with structured data, models, ethics and regulations: we can't just go YOLO and make something and expect it to work. That will cost us a lot of time, iteration cycles and frustration. That doesn't mean that there are no integrative parts in the design, design is by nature integrative since you are connected dots to create new solutions. Instead we create a systematic framework wherin we have room for integrative design and some freedom to plan and do.
...
It's an effective method, but essentially it's all about defining a problem and solution; some people didn't re-invented the wheel but a taxonomy to order design processes. These processes and terms are useful for collaboration, research and client communication, but usually actually practicing it in the field become more integrative; maybe because we're humans and not computers. That's fine ofcourse, and it makes us feel better about ourselves when having such a framework in which we can design right? It gives us a sense of direction and progress; and ensures we keep making it. Furthermore, it resulted in great accumulation of design techniques which are tried and tested! **Do the full linkedin Learning course below and save the certificate to your github and evidence it in your learning- and worklog**
...
Let's zoom in on this proces again, let's specifically use this model to define an array of solutions and select one. That way we can present and discuss our design solutions with our peers in datalab tomorrow (or clients/collegues) and potentially iterate; improve, on it further.
...
- Clearly define it in max 100 words! You can also only just use one word too; e.g. hunger. Remember, you have to be able to explain it tomorrow!
