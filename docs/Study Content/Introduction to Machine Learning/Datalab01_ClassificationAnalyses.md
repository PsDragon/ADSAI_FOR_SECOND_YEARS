...
0. Open your python file (MachineLearning_OosterhoutModels_...) used for the final delivery of your model. If you didn't fill in the assignment template yet, [download it here](https://github.com/BredaUniversityADSAI/ADS-AI/blob/366ad0c6e74d2c2adf62e5b608b60298b824dfb2/docs/Study%20Content/Introduction%20to%20Machine%20Learning/Assets/MachineLearning_TemplateScript_FirstName_LastName_StudentNumber.ipynb.ipynb) and fill it in accordingly: use the **User Guide**.
