...
0. **Define your workspace**
   ...
   ```
    ...
    🔐 **Please refer to [Authentication with AML](Authentication%20with%20MS%20AML%20.html) for more details on the different types of authentication and their uses** 🔐
