...
b) Compute the **determinant and transpose (by hand)** of the following matrices.
1. <figure>
...
> hint: use Python and Numpy (numpy.linalg.det and .T) to check if your answers are correct
