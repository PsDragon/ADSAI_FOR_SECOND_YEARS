...
c) Please read until Section 2.3 of the linear algebra text you can find [here](https://www.deeplearningbook.org/contents/linear_algebra.html).

> Note: This text also covers matrix multiplication. Do not worry if you find it hard to understand at the moment. We will cover it tomorrow and on Wednesday. But it helps to be prepared before you arrive.
