...
Please open the jupyter notebook **PCAinPractice**, explore the code and
...
- [ ] In capturing 90% of the variance in the data using PCA, by what ratio  have we reduced the size of the original dataset?
