...
Now let's dive into some of the funamental ways of learning how to code, namely develop an intuition for computaional thinking via algorithms and flowcharts.
