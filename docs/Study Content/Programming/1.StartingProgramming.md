...
Before we dive into code, let's first get into the right mindset.
...
Now let's dive into some of the fundamental ways of learning how to code, namely develop an intuition for computaional thinking via algorithms and flowcharts.
...
> Please upload your answers to your Github Repositories.
