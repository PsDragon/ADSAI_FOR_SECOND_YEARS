...
To understand what the ratings data measure, please read the [ratings data glossary](https://edubuas.sharepoint.com/:w:/t/2022-23BFAI1.P2-01ADSAI/EcWAU0_z4ZNIlpoEEYgY5xkBEgBgoyvjDAw6gQMGgUOj6w?e=e5TdvL).
...
```python
df.to_csv('banijay_op1data_ratings.csv', compression='zip')
```
