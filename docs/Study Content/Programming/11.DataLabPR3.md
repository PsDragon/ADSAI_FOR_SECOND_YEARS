...
We start with the content data and then move on to the ratings data.

If you have already explored, cleaned and prepared the data in the workshops earlier this week, you can skip this section and move on to Use-Case 2.
