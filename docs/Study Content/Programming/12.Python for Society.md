...
Use the Twitter API to scrape data from Twitter using the Python library ```tweepy```. To make it interesting, pick a topic of your choice (e.g., a tv show), scrape twitter data, and please remember to upload it to Github using a data format of your choice (JSON, CSV, or PKL).
...
If Datacamp is not a friend, please watch the following video and code along.
