...
> Week 4 onwards you will start building your machine learning models. There will be no further new use-cases. This allows you to approach the project at a pace that you are comfortable with, but keep in mind that you will need to complete all the use-cases by Week 8 to get a good grade.
