...
- [ ] Implement a linear regression algorithm using only ```numpy``` and the tools of Linear Algebra. [clicky](../BlockB/Project%20Requirements/MachineLearningRequirements.html#linear-algebra-and-machine-learning)
