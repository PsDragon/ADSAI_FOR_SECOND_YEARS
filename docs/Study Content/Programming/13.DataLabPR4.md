...
- [ ] read in the ```banijay_op1data_twitter_raw.json``` file from [here](https://edubuas.sharepoint.com/:u:/t/2022-23BFAI1.P2-01ADSAI/EUrNefNkNe1DkwIQQlZOmOIBwqyofoaSa6TVHkdmx60ZfQ?e=Ia8iYk) using the following code:
