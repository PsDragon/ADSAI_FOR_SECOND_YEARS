...
## Blended Learning - Data Camp - Introduction To Numpy (4 hours)

- [ ] Please read the ```INTRODUCTION TO NUMPY``` section in DataCamp which you can find [here](https://www.datacamp.com/tutorial/python-numpy-tutorial).
