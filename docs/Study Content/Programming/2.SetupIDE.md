...
- [ ] Download and install [VS Code](https://code.visualstudio.com/docs/setup/setup-overview.){:target="_blank"}.
...
<br>
However, note that the *Github Repository* and *Github Pages* webpage you develop as part of this assignment can be used to showcase your [DataScience and AI Portfolio](https://www.datacamp.com/blog/how-to-build-a-great-data-science-portfolio-with-examples){:target="_blank"} as you progress through the study program.</mark>
