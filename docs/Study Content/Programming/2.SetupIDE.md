...
- [ ] I recommend downloading and installing [Github Desktop](https://desktop.github.com/){:target="_blank"}. This makes is easier to commit your jupyter notebooks and other deliverables as you work on your creative brief.
...
- [ ] Please read the article on **How to build a great data science portfolio** which you can find [here](https://www.datacamp.com/blog/how-to-build-a-great-data-science-portfolio-with-examples){:target="_blank"}.

- [ ] [Optional] Please complete the course **Introduction to Github** by clicking [here](https://www.datacamp.com/courses/introduction-to-git){:target="_blank"}.

<mark> Please note that these assignments do not count towards your final grade.</mark>
