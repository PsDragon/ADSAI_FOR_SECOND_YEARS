...
- [ ] Please start with the ```Learn Python 3``` module in Code Academy which you can find [here](https://www.codecademy.com/learn/learn-python-3){:target="_blank"}. You are expected to have completed atleast until <mark>module 8</mark> of this course by the **end of week 1**.
