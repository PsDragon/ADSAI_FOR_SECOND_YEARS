...
- [ ] Understand common operations and methods on Python data types
...
> While such data structures may seem complex at the moment, please remember that with experience, and a habit of coding, you will learn to understand the use of such data structures. However, lists are the most commonly used structure and I recommend becoming comfortable with Python lists.
...
- [ ] Rewrite the following python code snippets using list comprehension and upload your scripts or notebooks to Github.
...
>Tip: check the example provided above in the text.

## Blended Learning - Introduction To Python

- [ ] Please continue with the ```Introduction to Python``` module in DataCamp which you can find [here](https://app.datacamp.com/learn/courses/intro-to-python-for-data-science){:target="_blank"}. You are expected to have completed this module by the **end of today**.

## DataLab Prepration

- [ ] Your Python IDE must be setup 
- [ ] Completed the ```Introduction to Python``` module in DataCamp.

```python
We will recap today's concepts and discuss the assignments in the Datalab tomorrow!
```
