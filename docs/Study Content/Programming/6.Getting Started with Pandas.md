...
## Blended Learning - Pandas [4 hrs]

- [ ] Please complete the ```Data Manipulation with Pandas``` module in DataCamp which can be found [here](https://app.datacamp.com/learn/courses/data-manipulation-with-pandas).
