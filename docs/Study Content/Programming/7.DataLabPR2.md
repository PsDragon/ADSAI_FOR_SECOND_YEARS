...
**Using Jupyter notebooks, write a Python function which prints out the location for a user supplied year of birth. Use a Pandas dataframe to store
and retrieve data.**
...
We will cover this topic in more detail in week3! Have a nice weekend :)
