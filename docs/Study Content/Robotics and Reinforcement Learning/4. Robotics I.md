...
| Linear Actuator | A linear actuator is a motor that is used to move a piston in a cylinder, either using a wrack and pinion or a worm gear to translate the rotational motion of the motr to linear motion in the cylinder. The piston is attached to a rod which can be used to move a load. | Linear actuators are commonly used in robotics to provide linear motion. Linear actuators are the electrical alternative to hydraulics or pneumatics. | ![Linear Actuator](https://cdn.shopify.com/s/files/1/0061/7735/7891/products/pa-14-transparent-bg_1024x1024@2x.png?v=1606487569) |
...
- [Tesla Onboard computer](https://electrek.co/2019/04/22/tesla-full-self-driving-computer-details/) - 
