...
<div style="text-align: center">
1. <img src="Images/rsroll_annot.gif" height="200" />
2. <img src="Images/rspitch_annot.gif" height="200" />
3. <img src="Images/rsyaw_annot.gif" height="200" />
</div>
...
For more details on quatenions and how they work please see the following tutorial: [Tutorial series on Quaternions](https://eater.net/quaternions)

Quarternions are used in RoboSuite to describe the orientation of objects and robots. 

The following function can be used to convert from quaternions to Euler (roll, pitch, yaw) angles:
...
>! Spoiler text
!Brain teaser solution: Quarternions are more useful than Euler angles because they are unique and do not suffer from gimbal lock.
!Brain teaser solution: Euler angles are more useful than quaternions because they are easier to understand and visualize.
...
Convert the following quaternions to Euler angles:<br>

- q = (1, 0, 0, 0)<br>
- q = (0.707, 0.707, 0, 0)<br>
...
- rpy = (0, 0, 0) -> q = (1, 0, 0, 0)
- rpy = (90, 0, 0) -> q = (0.707, 0.707, 0, 0)
- rpy = (180, 180, 180) -> q = (0.5, 0.5, 0.5, 0.5)
- rpy = (45, 135, 225) -> q = (0.5, 0.5, 0.5, -0.5)

- q = (1, 0, 0, 0) -> rpy = (0, 0, 0)
- q = (0.707, 0.707, 0, 0) -> rpy = (90, 0, 0)
- q = (0.5, 0.5, 0.5, 0.5) -> rpy = (180, 180, 180)
- q = (0.5, 0.5, 0.5, -0.5) -> rpy = (45, 135, 225)
