...
Control theory is a vast field across all types of engineering, and is a very important topic in robotics. In this section we will cover the basics of control theory, and how it applies to robotics. There are many different types of control algorithms, and we will cover some of the most common ones in this module. The overlap between control theory and data science comes from new data driven control algorithms that are being developed. These algorithms are based on machine learning, and are able to learn how to control a robot from data. We will cover reinforcement learning in the next module. 
...
Summarise what is presented in this video and put it in context of the module.
