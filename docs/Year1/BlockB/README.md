...
|----------|-------------|-------------|-------------|-------------|
| 1 | Pre-process and clean data | Content and Ratings Data | Banijay, SKO | [clicky](#use-case-1-pre-processing-and-cleaning-data)
...
| 6 | Submission Checklist | N.A | N.A | [clicky](#use-case-6-submission-checklist)
...
If you seek a challenge (and a higher grade), you can:
...
Please ensure that your notebooks:

- [ ] have a clear purpose. e.g., one (one per data source) notebook for the data preparation (reading and clearning data), one notebook for data understanding (insights based on the merged dataset), one notebook for the ML model.
- [ ] follow appropriate file naming conventions
- [ ] are well-commented and adheres to PEP-8 (avoid object names such as ```df1```, ```df1_final``` etc..
- [ ] the visualisations included have legends and axes labels.
