...
| [Map of 100 meters by 100 meters with statistics](https://www.cbs.nl/nl-nl/dossier/nederland-regionaal/geografische-data/kaart-van-100-meter-bij-100-meter-met-statistieken) | [CBS/SN]((https://opendata.cbs.nl/statline/portal.html?_la=nl&_catalog=CBS)) | Grid/Postal code | Annual publication of sociological data of the Central Bureau of Statistics of the Netherlands. Contains demographics, housing, energy, social security, density, and proximity of facilities to  low-regional division into grids and postal code, 2015 and beyond. |
